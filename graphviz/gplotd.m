function [dxu, dyu, dxl, dyl, ux, uy] = gplotd(A,xy,varargin)
...
%
% Modified for use in graphvisualizer.m Nov. 2015
% Now also returns all XY vectors for further use in plotting directed 
% arrows. 
%
...
plot(ux,uy,'k-',params)
hold on
plot(dxu,dyu,'k-',params)
plot(dxl,dyl,'k-',params)
